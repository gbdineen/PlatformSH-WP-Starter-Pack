...
{ 
    ...
    register_setting( 'my-own-theme-options-for-footer', 'footer_background' );
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       <label style="width: 100%;" for="upload_image">Footer Logo</label>
                        ...
                        <br />
                        <br />
                        <label style="width: 100%;" for="upload_image">Footer Background</label>                            
                        <?php echo my_image_uploader('footer_background', 'Upload Image'); ?>
                        <br />
                        <br />
